...
- Since liquidity runoff and inflow assumptions are held constant across scenarios, liquidity metrics do not vary by rate scenario. This is intended to illustrate model structure rather than dynamic funding stress behavior.
